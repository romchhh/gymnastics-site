...
const StudioLifePage = () => {
  ...
  const trainers = [
    {
      name: 'Демиденко Катерина Володимирівна',
      photos: [
        '/images/kateryna/FB_IMG_1594723553246.jpg',
        '/images/kateryna/FB_IMG_1614716263319.jpg',
        '/images/kateryna/IMG_20201217_232627.jpg'
      ],
      description: 'Досвід роботи тренером- 6 років. Приймала участь у багатьох змаганнях з повітряної гімнастики, poledance. Надихаюсь цим видом спорта. Пропоную здоровий спосіб життя, рух в повітрі, гнучкість, витривалість, гармонію душі і тіла!!'
    },
    {
